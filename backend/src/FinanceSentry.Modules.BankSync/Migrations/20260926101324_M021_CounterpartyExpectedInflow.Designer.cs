...
namespace FinanceSentry.Modules.BankSync.Migrations
{
    ...
    [Migration("20260926101324_M021_CounterpartyExpectedInflow")]
    partial class M021_CounterpartyExpectedInflow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinanceSentry.Modules.BankSync.Domain.Counterparty", b =>
                {
                    ...
                    b.Property<decimal?>("ExpectedMonthlyInflowAmount")
                        .HasPrecision(15, 2)
                        .HasColumnType("numeric(15,2)");

                    b.Property<string>("ExpectedMonthlyInflowCurrency")
                        .HasMaxLength(3)
                        .HasColumnType("character varying(3)");
            ...
            modelBuilder.Entity("FinanceSentry.Modules.BankSync.Domain.Transaction", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsActive", "PostedDate")
                        .HasDatabaseName("idx_transaction_user_active_posted_date");
