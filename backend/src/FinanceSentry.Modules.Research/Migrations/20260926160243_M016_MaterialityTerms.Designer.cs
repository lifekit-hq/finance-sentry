...
namespace FinanceSentry.Modules.Research.Migrations
{
    ...
    [Migration("20260926160243_M016_MaterialityTerms")]
    partial class M016_MaterialityTerms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceSentry.Modules.Research.Domain.MaterialityTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Term")
                        .IsUnique()
                        .HasDatabaseName("idx_materiality_terms_term");

                    b.ToTable("materiality_terms", "research");
                });
