...
// HTTP trace spine (spec 023 amendment, 2026-09-13) — ASP.NET Core + HttpClient + Npgsql spans via OTLP/HTTP.
builder.Services.AddObservabilityTracing(builder.Configuration);
